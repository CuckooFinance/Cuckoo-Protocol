...
contract ChainlinkPriceOracleProxy is Ownable, PriceOracle {
     ...
     * @dev Implements the PriceOracle interface for Cuckoo v2.
        ...
        returns (uint256)
    {
        ...
        (, int256 chainlinkPrice, , , ) =
            AggregatorV3Interface(config.chainlinkAggregatorAddress)
                .latestRoundData();
        ...
        if (config.chainlinkPriceBase == 1) {
            ...
            (, int256 ethPriceInUsd, , , ) =
                AggregatorV3Interface(ethUsdChainlinkAggregatorAddress)
                    .latestRoundData();
