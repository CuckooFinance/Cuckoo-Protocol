...
/**
 * @title Cuckoo's WhitePaperInterestRateModel Contract
 * @author Cuckoo
 * @notice The parameterized model described in section 2.4 of the original Cuckoo Protocol whitepaper
 */
contract WhitePaperInterestRateModelV2 is InterestRateModel, Ownable {
     ...
     */
    uint256 public blocksPerYear = 8760000;
     ...
     * @param multiplierPerYear The rate of increase in interest rate wrt utilization (scaled by 1e18)
     */
    function updateRateModel(uint256 baseRatePerYear, uint256 multiplierPerYear)
        external
        onlyOwner
    {
        updateRateModelInternal(baseRatePerYear, multiplierPerYear);
     ...
     * @param multiplierPerYear The rate of increase in interest rate wrt utilization (scaled by 1e18)
     */
    function updateRateModelInternal(
